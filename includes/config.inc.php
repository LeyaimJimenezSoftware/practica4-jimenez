...
$url='http://localhost/directorioPersonasNuevo/';
...
defined('DATABASE_NAME') ? NULL : define('DATABASE_NAME', 'practica3db');
defined('DATABASE_USER') ? NULL : define('DATABASE_USER', 'root');
defined('DATABASE_PASSWORD') ? NULL : define('DATABASE_PASSWORD', 'kikiondo');
